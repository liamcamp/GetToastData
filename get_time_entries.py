...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("get_time_entries.log"),
...
def main():
    ...
    try:
        ...
        # For single day, use businessDate parameter which is more efficient
        if start_date_str == end_date_str:
            business_date = start_date_str
            logger.info(f"Fetching time entries for business date: {business_date}")
            
            # Fetch time entries data using businessDate
            ...
            # For date range, convert to ISO format and use startDate/endDate
            ...
            # Fetch time entries data using date range
            time_entries_response = client.get_time_entries(
