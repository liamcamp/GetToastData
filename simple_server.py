...
def run_get_orders_script(task_id: str, params: dict):
    ...
    try:
        ...
        cmd = [sys.executable, 'get_orders.py']
...
def debug_info():
    ...
    return jsonify({
        ...
        'files': {
            'get_tips_exists': os.path.exists('get_tips.py'),
            'get_orders_exists': os.path.exists('get_orders.py'),
            'config_exists': os.path.exists('config.py'),
            'toast_client_exists': os.path.exists('toast_client.py')
        }
    })
...
if __name__ == '__main__':
    try:
        ...
        required_files = ['get_tips.py', 'get_orders.py', 'config.py', 'toast_client.py']
